CLASS zcl_cargar_renta_cars DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_cargar_renta_cars IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    DATA: lt_brands    TYPE TABLE OF zrent_brands_mg,
          lt_cars      TYPE TABLE OF zrent_cars_mg,
          lt_customers TYPE TABLE OF zrent_custome_mg.
...
** BRANDS **
    ...
    DELETE FROM zrent_brands_mg.
    INSERT zrent_brands_mg FROM TABLE @lt_brands.
    SELECT * FROM zrent_brands_mg INTO TABLE @lt_brands.

    out->write( sy-dbcnt ).
    out->write( 'zrent_brands_mg data inserted successfully!').
...
** CARS**
    ...
    DELETE FROM zrent_cars_mg.
    INSERT zrent_cars_mg FROM TABLE @lt_cars.
    SELECT * FROM zrent_cars_mg INTO TABLE @lt_cars.

    out->write( sy-dbcnt ).
    out->write( 'zrent_cars_mg data inserted successfully!').
...
** CUSTOMERS**
    ...
    DELETE FROM zrent_custome_mg.
    INSERT zrent_custome_mg FROM TABLE @lt_customers.
    SELECT * FROM zrent_custome_mg INTO TABLE @lt_customers.

    out->write( sy-dbcnt ).
    out->write( 'zrent_custome_mg data inserted successfully!').
