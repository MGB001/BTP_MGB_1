...
define view entity zc_clientes_mg as select from ztclientes_mg as Clientes
inner join   ztclnt_lib_mg as ClientesLib on Clientes.id_cliente = ClientesLib.id_cliente
{
