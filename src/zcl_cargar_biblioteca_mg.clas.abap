CLASS zcl_cargar_biblioteca_mg DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_cargar_biblioteca_mg IMPLEMENTATION.
...
*last_changed_at       : abp_lastchange_tstmpl;
    ...
    DATA: lt_acc_categ TYPE TABLE OF ztacccateg_mg,
          lt_catego    TYPE TABLE OF ztbcateg_mg,
          lt_clientes  TYPE TABLE OF ztclientes_mg,
          lt_clnts_lib TYPE TABLE OF ztclnt_lib_mg,
          lt_libros    TYPE TABLE OF ztlibros_mg.
...
******** TABLA1 ********
    ...
    DELETE FROM ztacccateg_mg.                         "#EC CI_NOWHERE.
    INSERT ztacccateg_mg FROM TABLE @lt_acc_categ.
...
******** TABLA3 ********
    ...
    "Delete possible entries; insert new entries
    DELETE FROM ztclientes_mg.
    INSERT ztclientes_mg FROM TABLE @lt_clientes.
...
******** TABLA4
    ...
    "Delete possible entries; insert new entries
    DELETE FROM ztclnt_lib_mg.
    INSERT ztclnt_lib_mg FROM TABLE @lt_clnts_lib.
...
******** TABLA5 ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    DELETE FROM ztlibros_mg.
    INSERT ztlibros_mg FROM TABLE @lt_libros.
